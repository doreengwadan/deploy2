    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-white py-4 shadow-md">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <h1 className="text-green-900 font-bold text-lg sm:text-xl">Mzuzu University</h1>

          <nav className="flex items-center space-x-4">
            {/* Notifications - Hidden on mobile */}
            <Link
              href="#"
              className="hidden sm:flex relative items-center text-green-900 font-bold hover:underline"
            >
            ...
            {user ? (
              <div className="relative">
                ...
                <button
                  ...
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-green-700 text-white font-bold flex items-center justify-center text-sm sm:text-base"
                >
